...
class GCN(nn.Module):
	def __init__(self, input_features: torch.Tensor, 
			weights: bool = False,
		...
		self.fcn = FullyConnectedModel(n_features = embedding_dim,
				n_hidden_layers = readout_n_hidden_layers, 
				n_hidden_dim = readout_hidden_dim, n_output_dim = n_output_dim)
